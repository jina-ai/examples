...
Follow the Jinabox instructions from the [Query from Docker](#query-from-docker) section above.
...
- [Jina YAML syntax for executor, driver and flow](https://docs.jina.ai/chapters/yaml/)
