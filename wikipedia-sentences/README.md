...
3. You have at least 3GB of free space on your hard drive. 
...
On your terminal,  you should now be located in the wikipedia-sentences folder. Let's install Jina and the other required python libraries. For futher information on installing Jina check out our [documentation](https://docs.jina.ai/chapters/core/setup/). 
...
To get started quickly, you can instantly index a very [small dataset of 50 sentences](data/toy-input.txt) with the following command. 
...
This step is optional, but we recommend that you come back to this step and later and index the full wikipedia sentence for better results. To index the [full dataset](https://www.kaggle.com/mikeortman/wikipedia-sentences) (almost 900 MB) follow these steps:
...
4. Set the input file by running `export JINA_DATA_FILE='data/input.txt'`
5. Set the number of docs to index by running `export JINA_MAX_DOCS=30000` (or whatever number you prefer. The default is `50`)
...
```
Once you run this command, you should see a JSON output returned to you. This contains the five most semantically similar sentences to the input sentence you provided in the data field. Feel free to alter the text in the data field and play around with other queries! Here is a explanation of what each parameter means. 

| Parameter name| Explanation |
|--|--|
| `top_k` | An integer determining the number of sentences to return in the search query |
| `mode` | Determines if the request should index or search. For futher reference see our [docs](https://docs.jina.ai/chapters/rest/). |
| `data` | The text input you want to query.   |
...
This diagram is a simple visual representation of the two Flows in this example. It shows the encoders is in Flow and the order of how data is processed.  

![116664240-7bad2500-a998-11eb-90fa-1d1268806602](https://user-images.githubusercontent.com/59612379/116866682-20836880-ac0c-11eb-9c3e-8b43b1d83771.jpeg)
...
If you want to run this example quickly without installing Jina, you can do so via Docker. 
